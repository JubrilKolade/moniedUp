...
import { authorizeAccountAccess, authorizeCardAccess } from '../middleware/account.middleware.js';
...
router.delete('/:cardId', authenticateToken, validate(deleteCardSchema), authorizeCardAccess, deleteCard);
